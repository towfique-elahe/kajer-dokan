...
@section('pageTitle', 'Resume Builder')
...
@section('main')
    <main id="resume">
        ...
        <!-- main content -->
        <section class="main">
            <form class="builder" action="{{ route('worker.resume.build') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <h3 class="r_heading">
                ...
                <div class="personal">
                    <div class="col">
                        ...
                        <div class="input">
                            ...
                            <input type="text" name="worker_name" id="worker_name" value="{{ $user->name }}" disabled
                                required>
                            <input type="hidden" name="worker_name" id="worker_name" value="{{ $user->name }}" required>
                        </div>
                        <div class="input">
                            <label for="worker_email">Email*</label>
                            <input type="email" name="worker_email" id="worker_email" value="{{ $user->email }}" disabled
                                required>
                            <input type="hidden" name="worker_email" id="worker_email" value="{{ $user->email }}"
                                required>
                        </div>
                        <div class="input">
                            <label for="worker_phone">Phone*</label>
                            <input type="tel" name="worker_phone" id="worker_phone" value="{{ $user->phone }}"
                                required>
                        </div>
                        <div class="input">
                            <label for="worker_address">Address*</label>
                            <input type="text" name="worker_address" id="worker_address" value="{{ $user->address }}"
                                required>
                        </div>
                        <div class="input">
                            <label for="worker_service">Service*</label>
                            <input type="text" name="worker_service" id="worker_service" value="{{ $user->service }}"
                                disabled required>
                            <input type="hidden" name="worker_service" id="worker_service" value="{{ $user->service }}"
                                required>
                        </div>
                    </div>
                    <div class="col">
