    ...
    <main id="resume">
        ...
        <section class="main">
            <div class="buttons">
                ...
                <a href="{{ route('admin.worker-resume-edit', ['id' => $worker->id]) }}" class="button submit"><iconify-icon
                        icon="iconamoon:edit-fill"></iconify-icon>Edit</a>
                @if ($resume)
                    <a href="{{ route('admin.worker-resume-delete', ['id' => $resume->id]) }}"
                        class="button negative"><iconify-icon icon="material-symbols:delete"></iconify-icon>Delete
                        Resume</a>
                @endif
            </div>
